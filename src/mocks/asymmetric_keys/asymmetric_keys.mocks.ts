...
import { PublicKeySpy, PrivateKeySpy, privateJWKeySpy, publicJWKeySpy } from '../jose/jose.mocks';
...
export const asymmetricKeysSpy: IAsymmetricKeys = {
  ...
  getKeysAsJWKKey: (keys: Keys): Promise<Either<BaseError, JWKeys>> => jest.fn as any
}